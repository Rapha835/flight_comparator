...
2. Il filtre selon TES critères, façon FlightList : fenêtre de dates aller (ex. 1–14 oct), fenêtre retour (ex. 19 oct–3 nov), durée du séjour en nuits, escales max, budget max.
...
Toute la configuration se fait dans Telegram : un **assistant de 7 questions** (`/config`) se lance à l'installation, et chaque critère reste modifiable à l'unité par commande — aucun besoin de rouvrir le code au quotidien.
...
| `/premium` | prix éco premium / affaires / première à la demande |
